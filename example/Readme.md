- [1] <strong>Rendering Mask :</strong> 
    ...
    ```
    dive --mask example/IFOF_R_global_all.nii.gz example/CST_R_global_all.nii.gz --glass_brain /Users/siddharthnarula/Downloads/ICBM152_adult.WM.nii.gz --background 1 
    ```
